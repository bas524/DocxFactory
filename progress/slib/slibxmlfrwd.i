...
.
function xml_getElementByAttr returns log(phContainer as handle, phCursorNode as handle, pcTagNsList as char, pcTagList as char, pcAttrNsList as char, pcAttrList as char, pcAttrValueList as char) {
    1
}
.
function xml_drillElementByAttr returns log(phContainer as handle, phCursorNode as handle, pcDrillTagNsList as char, pcDrillTagList as char, pcTagNsList as char, pcTagList as char, pcAttrNsList as char, pcAttrList as char, pcAttrValueList as char) {
    1
}
.
function xml_getChildByAttr returns log(phParent as handle, phCursorNode as handle, pcTagNsList as char, pcTagList as char, pcAttrNsList as char, pcAttrList as char, pcAttrValueList as char) {
    1
}
.
...
function xml_getNextTag returns log(phContainer as handle, phCursorNode as handle, input - output pcCursorPos as char, output pcStringValue as char) {
    1
}
.
function xml_getNextTagSkipBlanks returns log(phContainer as handle, phCursorNode as handle, input - output pcCursorPos as char, output pcStringValue as char) {
    1
}
.
