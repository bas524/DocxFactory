...
void DocxMergerFile::deserializeFields(UnzipFile* p_unzipFile) {
  ...
  for (i = 0; i < l_size; ++i) {
    ...
    switch ((DocxMergerField::FieldType) l_type) {
      case DocxMergerField::TYPE_TEXT: l_field = new DocxMergerTextField();
        break;
      case DocxMergerField::TYPE_NUMBER: l_field = new DocxMergerNumberField();
        break;
      case DocxMergerField::TYPE_DATE_TIME: l_field = new DocxMergerDateTimeField();
        break;
      case DocxMergerField::TYPE_BOOLEAN: l_field = new DocxMergerBooleanField();
        break;
      case DocxMergerField::TYPE_ALT_CHUNK: l_field = new DocxMergerAltChunkField();
        break;
      case DocxMergerField::TYPE_PIC: l_field = new DocxMergerPicField();
        break;
      case DocxMergerField::TYPE_BARCODE: l_field = new DocxMergerBarcodeField();
        break;
      case DocxMergerField::TYPE_CHART:

        l_chartType = p_unzipFile ->readNum<int16>();
        switch ((DocxMergerChartField::ChartType) l_chartType) {
          case DocxMergerChartField::CHART_SERIES: l_field = new DocxMergerChartFieldSeries();
            break;
          case DocxMergerChartField::CHART_SINGLE_SERIES: l_field = new DocxMergerChartFieldSingleSeries();
            break;
          case DocxMergerChartField::CHART_FIXED_SERIES: l_field = new DocxMergerChartFieldFixedSeries();
            break;
          case DocxMergerChartField::CHART_X_Y: l_field = new DocxMergerChartFieldXY();
            break;
          case DocxMergerChartField::CHART_X_Y_SIZE: l_field = new DocxMergerChartFieldXYSize();
            break;
        }
