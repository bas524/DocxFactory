...
void LocaleFunc::setDateFormat(const string& p_dateFormat) {
  ...
  if (p_dateFormat.empty()) {
    ...
    switch (l_dateFormat) {
      case time_get<char>::dmy: m_dateFormat = "dmy";
        break;
      case time_get<char>::mdy: m_dateFormat = "mdy";
        break;
      case time_get<char>::ymd: m_dateFormat = "ymd";
        break;
      case time_get<char>::ydm: m_dateFormat = "ydm";
        break;
      default: m_dateFormat = "mdy";
        break;
    }
  }
  else {
...
void LocaleFunc::getNumFormat(const string& p_format, NumFormat* p_numFormat) {
  ...
  while (true) {
    ...
    while (l_pos < l_len) {
      ...
      if (l_ch == '[' && !l_escape) {
        switch (l_part) {
          case NUM_PRE: l_part = NUM_COLOR;
            break;
          case NUM_COLOR: break;
          case NUM_PREFIX: break;
          case NUM_INT: l_part = NUM_SUFFIX;
            break;
          case NUM_DEC: l_part = NUM_SUFFIX;
            break;
          case NUM_SUFFIX: break;
        }

        switch (l_part) {
          case NUM_COLOR: l_color += l_ch;
            break;
          case NUM_PREFIX: l_prefix += l_ch;
            break;
          case NUM_INT: break;
          case NUM_DEC: break;
          case NUM_SUFFIX: l_suffix += l_ch;
            break;
        }
      }
      else
        if (l_ch == ']' && !l_escape) {
        switch (l_part) {
          case NUM_PRE: l_part = NUM_PREFIX;
            break;
          case NUM_PREFIX: break;
          case NUM_INT: l_part = NUM_SUFFIX;
            break;
        ...
        switch (l_part) {
          case NUM_COLOR: l_part = NUM_PREFIX;
            break;
        }
      }
      else
        if (l_ch == '#' && !l_escape) {
        switch (l_part) {
          case NUM_PRE: l_part = NUM_INT;
            break;
          case NUM_COLOR: break;
          case NUM_PREFIX: l_part = NUM_INT;
            break;
          case NUM_INT: if (l_leftDig > 0) l_part = NUM_SUFFIX;
            break;
          case NUM_DEC: break;
          case NUM_SUFFIX: break;
        }
        ...
        switch (l_part) {
          ...
          case NUM_PREFIX: l_part = NUM_INT;
            break;
          case NUM_INT: break;
          case NUM_DEC: if (l_rightExt > 0) l_part = NUM_SUFFIX;
            break;
          case NUM_SUFFIX: break;
        }
        ...
        switch (l_part) {
          ...
          case NUM_PREFIX: l_prefix += l_ch;
            break;
          case NUM_INT: l_leftDig++;
            break;
          case NUM_DEC: l_rightDig++;
            break;
          case NUM_SUFFIX: l_suffix += l_ch;
            break;
        }
        ...
        if (l_ch == '.' && !l_escape) {
        switch (l_part) {
          case NUM_PRE: l_part = NUM_DEC;
            break;
          case NUM_COLOR: break;
          case NUM_PREFIX:
          case NUM_INT: l_part = NUM_DEC;
            break;
          case NUM_DEC: l_part = NUM_SUFFIX;
            break;
          case NUM_SUFFIX: break;
